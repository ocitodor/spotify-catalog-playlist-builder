...
# ---------------------------------------------------------------------------
CLIENT_ID = os.environ.get("SPOTIPY_CLIENT_ID", "B2c4d04c6d27424e9f0c166d78d1b2a4")
CLIENT_SECRET = os.environ.get("SPOTIPY_CLIENT_SECRET", "8e307579efe54c2aba05fffbe314ac7e")
